...
export default function Landing() {
  ...
  return (
    <Layout title="London  - Giao dịch ngoại hối và đầu tư tài chính">
      {/* Market Data Ticker */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1">
            ...
            <h2 className="text-lg font-bold mt-2">
              Sàn giao dịch chứng khoán London HSC chào đón Thông đốc Samuel
              Garcia tại Nuevo León, Mexico
            </h2>
            <p className="text-sm mt-2">
              Sàn giao dịch chứng khoán London HSC rát hân hạnh được chào đón
          ...
          {/* Center Column - London  Info */}
          <div className="md:col-span-1">
            <div>
              <h2 className="text-lg font-bold">LONDON HSC</h2>
              <p className="text-sm mt-2">
            ...
            <div className="mt-12">
              ...
              <p className="text-sm mt-2">
                ...
                khoán quốc tế nhất với hàng ngàn công ty từ hơn 60 quốc gia
                  ...
                  với các sàn giao dịch quốc tế ở châu Á và châu Phi,  dự
            ...
            <div className="w-full text-xs">
              <iframe
                ...
                referrerPolicy="strict-origin-when-cross-origin"
                  src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=vi_VN&amp;symbol=SPREADEX%3AFTSE#%7B%22symbol%22%3A%22SPREADEX%3AFTSE%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A320%2C%22utm_source%22%3A%22london-.com%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22london-.com%2F%22%7D"
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-4">
            <h2 className="text-3xl font-bold">
              Sở giao dịch chứng khoán London  và nền tảng WisdomTree ở châu
              Âu
            </h2>
            <p className="text-sm">
